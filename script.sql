...
-- CUIDANDO DA INTEGRIDADE DO BANCO DE DADOS (FOREIGN KEY)
...
change column n_numeprod n_numeprodu int not null;
...
-- ALTERANDO AS TABELAS.
 ...
 alter table comclien modify column c_estaclien varchar(30);
 desc comclien;
 ...
 values (1, '0001', 'AARONSON', 'AARONSON FURNITURE LTDA', '2015-02-17', '17.807.928/0001-85', '(21) 8167-6584', 'QUEIMADOS', 'RJ');
...
insert into comclien(n_numeclien, c_codiclien, c_nomeclien, c_razaclien, d_dataclien, c_cnpjclien, c_foneclien, c_cidaclien, c_estaclien)
 values 
 (default, '0004', 'GREAT AMERICAN MUSIC', 'GREAT AMERICAN MUSIC', '2015-02-17', '11.880.735/0001-73', '(75) 7815-7801', 'SANTO ANTÔNIO DE JESUS', 'BA'),
 (default, '0005', 'LIFE PLAN COUNSELLING', 'LIFE PLAN COUNSELLING', '2015-02-17', '75.185.467/0001-52', '(17) 4038-9355', 'BEBEDOURO', 'SP'),
 (default, '0006', 'PRACTI-PLAN', 'PRACTI-PLAN LTDA', '2015-02-17', '32.518.106/0001-78', '(28) 2267-6159', 'CACHOEIRO DE ITAPEMIRI', 'ES'),
 (default, '0007', 'SPORTSWEST', 'SPORTSWEST LTDA', '2015-02-17', '83.175.645/0001-92', '(61) 4094-7184', 'TAGUATINGA', 'DF'),
 (default, '0008', 'HUGHES MARKETS', 'HUGHES MARKETS LTDA', '2015-02-17', '04.728.160/0001-02', '(21) 7984-9809', 'RIO DE JANEIRO', 'RJ'),
 (default, '0009', 'AUTO WORKS', 'AUTO WORKS LTDA', '2015-02-17', '08.271.985/0001-00', '(21) 8548-5555', 'RIO DE JANEIRO', 'RJ'),
 (default, '0010', 'DAHLKEMPER', 'DAHLKEMPER LTDA', '2015-02-17', '49.815.047/0001-00', '((11) 4519-7670', 'SÃO PAULO', 'SP');
 ...
 -- COMPARANDO STRING (iniciam com a letra "L"
 select n_numeclien, c_codiclien, c_razaclien
 from comclien
